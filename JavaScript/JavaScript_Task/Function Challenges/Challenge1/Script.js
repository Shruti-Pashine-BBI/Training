...
//           if the option is 3, increase the value AT POSITION 3 of the array by 1. Make sure to
//           check if the input is a number and if the number makes sense (e.g answer 52 wouldn't
//           make sense, right?)
